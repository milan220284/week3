...
// Number Mastermind (choose 4 out of 6 numbers without duplication), code motivated by https://github.com/enu-kuro/zku-final-project
...
template MastermindVariation() {
    ...
    // private key, protects from brute force attacks
    ...
    for (j=0; j<4; j++) {
        ...
        lessThan[j+4].out === 1;
        for (k=j+1; k<4; k++) {
            // Create a constraint no duplication
